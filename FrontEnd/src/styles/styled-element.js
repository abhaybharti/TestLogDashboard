...
import { DeleteOutline, GpsFixed, BugReport } from "@material-ui/icons";
...
export const AddProductDefect = styled.button`
  border: none;
  border-radius: 10px;
  padding: 5px 10px;
  background-color: ${(props) => (props.primary ? "DarkMagenta" : "SeaGreen")};
...
export const MaintenanceButton = styled.button`
  border: none;
  border-radius: 10px;
  padding: 5px 10px;
  background-color: ${(props) => (props.primary ? "DarkMagenta" : "SeaGreen")};
...
export const MyIntermittentOutline = styled(DeleteOutline)`
  color: red;
  cursor: pointer;
`;

export const MyBugOutline = styled(BugReport)`
  color: red;
  cursor: pointer;
`;

export const MyFixOutline = styled(GpsFixed)`
  color: red;
  cursor: pointer;
`;
