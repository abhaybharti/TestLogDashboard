...
const updateSuiteRunningStatus = (request, response) => {
  ...
  if (typeof startdate !== "undefined" && startdate.length !== 0) {
    query = `UPDATE suitestatus SET status='${status}', startdate = '${startdate}', enddate = '9999-99-99 99:99:99:999' WHERE suite = '${suite}' and env='${env}' and subscriptionkey=${subscriptionkey};`;
  }
